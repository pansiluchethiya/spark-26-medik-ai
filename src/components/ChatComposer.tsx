...
export function ChatComposer({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="w-full rounded-[20px] border border-line bg-card p-3 shadow-[0_8px_32px_rgba(34,48,44,0.08)] backdrop-blur transition focus-within:border-accent/50 focus-within:shadow-[0_8px_32px_rgba(29,92,82,0.12)] dark:border-[#2c4039] dark:bg-[#192622]/95"
    >
      {isEditing && (
