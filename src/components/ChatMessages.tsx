      ...
      {messages.map((message, index) => {
        ...
        return (
          <article
            ...
            className={cn(
              'animate-rise min-w-0 max-w-full rounded-2xl border p-4 text-[15px] leading-relaxed shadow-sm sm:p-[18px_22px]',
              isUser
                ? 'ml-auto w-fit max-w-[92%] rounded-br-md border-clay-border bg-clay-soft text-ink sm:max-w-[85%] dark:bg-[#21302b] dark:text-[#e8f0ee] dark:border-[#6d4b3c]'
                : 'w-full rounded-bl-md border-line bg-card text-ink dark:border-[#2c4039] dark:bg-[#192622] dark:text-[#e8f0ee]',
            )}
          >
